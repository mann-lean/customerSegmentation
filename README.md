...
![Power BI](https://img.shields.io/badge/Business_Intelligence-Power_BI-yellow.svg)
...
*(To view the complete, segment-by-segment strategic breakdown, visit the live dashboard link above).*
...
![App Demo](artifacts/vis/CustomerSegmentationBIDashboard.gif) 
...
├──BI Dashboard/               # Contains the `.pbix` dashboard file and a PDF export for quick browser viewing.
...
```
__4. To view the BI reporting__ <br> open `BI Dashboard/Retail Customer Segmentation analysis Dashbord.pbix` using Power BI Desktop.
...
<!-- * 🌐 **Portfolio:** [View my complete portfolio](https://YOUR_PORTFOLIO_LINK)